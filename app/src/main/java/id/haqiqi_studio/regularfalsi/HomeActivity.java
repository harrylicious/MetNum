...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //https://play.google.com/store/apps/details?id=id.haqiqi_studio.regularfalsi
        ...
        gauss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), GaussJordanSelector.class));
            }
        });
    ...
    void openUrl() {
        String url = "https://m.facebook.com/harry.s03";
